...
namespace EcoSim.Grazing
{
    class QLearningBrainMk1 : IBrain
    {
            ...
            public Instruction ToInstruction(GameState s)
            {
                ...
                switch(Kind)
                {
                    ...
                    case ActionKind.Go:
                        ...
                        target = targets.OrderBy(e => (e.Position - s.Report.ThisEntity.Position).Length()).FirstOrDefault();
                        if (target != null)
                            return new Instruction.GoTo(target.PositionX, target.PositionY, 1);
                        ...
                        return new Instruction.GoTo(dir.X, dir.Y,1);
        ...
        private struct State
        {
            ...
            public long Compressed => CloseFoodDirections | FoodRichDirections << 8| Penalty << 16;
        ...
        private class GameState
        {
            public State Value
            {
                get
                {
                    ...
                    res.Penalty = (byte)(Penalty * ((1 << 3) - 1));
                    return res;
                }
            }
